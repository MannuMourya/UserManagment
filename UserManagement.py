...
# Database setup
DATABASE_URL = "oracle+oracledb://SYSTEM:YourStrongPassword@localhost:1521/XE"
...
class UserManagementApp:
    ...
    def show_login_page(self):
        ...
        ctk.CTkLabel(login_frame, text="University ID").pack(pady=5)
    ...
    def show_signup_page(self):
        ...
        fields = ["Name", "University ID", "Course", "University Email", "Address", "Phone No", "Password"]
        self.entries = {}
    ...
    def show_mst_entry_page(self):
        ...
        ctk.CTkLabel(mst_frame, text="Enter MST 1 and MST 2 Marks (Max: 20)").pack(pady=5)
        ...
        try:
            for subject, entry in self.mst1_entries.items():
                ...
                if not (0 <= mst1_score <= 20) or not (0 <= mst2_score <= 20):
                    messagebox.showerror("Error", "Marks should be between 0 and 20.")
                    return
